...
[Export] public float Speed = 300f; // velocidad de movimiento
...
public override void _PhysicsProcess(double delta)
{
	...
	ZIndex = (int)Position.Y; // actualizar ZIndex según posición
}
...
private void StartAttack(int attackNumber)
{
	...
	// Honestamente, ni idea (posiblemente ajuste de dirección)
...
private void CheckAttackHits()
{
	...
	foreach (var obj in attackArea.GetOverlappingBodies())
	{
		...
		// Y aquí o donde mejor venga contadores y todo lo necesario
